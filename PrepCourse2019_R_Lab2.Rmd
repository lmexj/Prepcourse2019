...
author: name: "name" # write your name inside quotation marks!
        affiliation: 
        email: 
...
* Which R function is intended to print version information about R? Write it down in this code chunk! 

This is the last question to the assignment, if you have answered all the questions, you can `knit` this Rmd file now. You won't be able to do so if there's any error or unanswered questions left in this file.
```{r}
sessionInfo() 
```
